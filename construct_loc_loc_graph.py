...
def get_parser():
    ...
    parser.add_argument("--user_count", default=2247, type=int, help="number of user")  # gowalla: 7768    foursquare: 45343
    parser.add_argument("--loc_count", default=5051, type=int, help="number of POI")  # gowalla: 106994 foursquare: 68879
