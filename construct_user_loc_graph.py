...
def get_parser():
    ...
    parser.add_argument("--user_count", default=2247, type=int, help="number of user")  # 45343  7768
    parser.add_argument("--loc_count", default=5051, type=int, help="number of POI")  # 68879  106994
